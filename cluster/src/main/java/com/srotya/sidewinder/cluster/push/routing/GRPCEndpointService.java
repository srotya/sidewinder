...
public class GRPCEndpointService implements EndpointService {
	...
	private ClusterReadServiceBlockingStub blockingReadStub;
	...
	public GRPCEndpointService(ManagedChannel channel) {
		...
		blockingReadStub = ClusterReadServiceGrpc.newBlockingStub(channel);
	}
	...
	public QueryResponses readData(Query query) throws IOException {
		return blockingReadStub.queryData(query);
	}
