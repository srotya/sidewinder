...
//						List<List<Tag>> tagsSet = engine.getTagsForMeasurement(dbName, measurementName, field);
//						for (List<Tag> tags : tagsSet) {
...
//	}
	...
	public List<Node> routeData(Point dp) {
		return strategy.getNodes(MiscUtils.tagHashCode(dp.getTagsList()), replica);
	}
