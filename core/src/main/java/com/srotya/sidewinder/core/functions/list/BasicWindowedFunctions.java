...
public class BasicWindowedFunctions {
	...
	@FunctionName(alias = { "nnderivative",
			"nndvdt" }, description = "Takes the non negative derivative value for each window of values", type = "windowed aggregate")
	public static class NonnegativeDerivativeFunction extends WindowedAggregator {
	...
	@FunctionName(alias = { "derivative",
			"dvdt" }, description = "Takes the derivative value for each window of values", type = "windowed aggregate")
	public static class DerivativeFunction extends WindowedAggregator {
	...
	public static class DiffFunction extends WindowedAggregator {
	...
	public static class RMSFunction extends WindowedAggregator {
	...
	public static class IntegralFunction extends WindowedAggregator {
	...
	public static class WindowedFirst extends WindowedAggregator {
	...
	public static class WindowedLast extends WindowedAggregator {
	...
	public static class WindowedMax extends WindowedAggregator {
	...
	public static class WindowedMean extends WindowedAggregator {
	...
	public static class WindowedMin extends WindowedAggregator {
	...
	public static class WindowedStdDev extends WindowedAggregator {
