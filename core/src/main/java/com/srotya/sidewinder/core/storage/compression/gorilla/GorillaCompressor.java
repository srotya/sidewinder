...
public class GorillaCompressor {
    ...
    public GorillaCompressor(long timestamp, BitOutput output) throws IOException {
        this(timestamp, output, new LastValuePredictor());
    }

    public GorillaCompressor(long timestamp, BitOutput output, Predictor predictor) throws IOException {
