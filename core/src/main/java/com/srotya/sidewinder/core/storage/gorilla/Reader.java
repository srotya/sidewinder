...
public class Reader {
	...
	public Reader(BitInput input, int pairCount, Predicate timePredicate, Predicate valuePredicate, boolean isFp,
	...
	public DataPoint readPair() throws IOException {
		...
		if (appendFieldValueName == null || appendTags == null) {
			...
			DataPoint dataPoint = new DataPoint(storedTimestamp, storedVal);
