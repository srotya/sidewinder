...
public class Compressor {
    ...
    public Compressor(long timestamp, BitOutput output) throws IOException {
    ...
    private void writeFirst(long timestamp, long value) throws IOException {
     ...
     * @throws IOException 
     */
    private void writeExistingLeading(long xor) throws IOException {
        out.skipBit();
     ...
     * @throws IOException 
     */
    private void writeNewLeading(long xor, int leadingZeros, int trailingZeros) throws IOException {
        out.writeBit();
