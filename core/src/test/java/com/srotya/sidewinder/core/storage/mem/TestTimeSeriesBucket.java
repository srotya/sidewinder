...
public class TestTimeSeriesBucket {
	...
	public void testDataPointWrite() throws RejectException {
		TimeSeriesBucket bucket = new TimeSeriesBucket(className, System.currentTimeMillis());
		...
		bucket = new TimeSeriesBucket(className, System.currentTimeMillis());
	...
	public void testReadWriteLongs() throws RejectException {
		...
		int count = 10000;
		TimeSeriesBucket series = new TimeSeriesBucket(className, ts);
...
//	@Test
	public void testConcurrentReadWrites() throws RejectException {
		...
		final TimeSeriesBucket series = new TimeSeriesBucket(className, ts);
